...
import { Trophy, Sparkles, ArrowLeft, Construction } from "lucide-react";
        ...
        <div className="relative z-10 flex flex-col items-center">
          ...
          <div className="relative mb-6">
            <div className="w-20 h-20 rounded-3xl bg-orange-50 border border-orange-100 flex items-center justify-center text-[#FF6B00]">
              <Trophy size={40} className="stroke-[1.8]" />
            </div>
            {/* Corner Badge */}
          ...
          <h1 className="text-2xl font-extrabold text-slate-800 tracking-tight mb-3">
            Bảng Xếp Hạng Đang Phát Triển
          </h1>

          {/* Description */}
          <p className="text-slate-505 text-sm leading-relaxed mb-8">
            Hệ thống đang hoàn thiện tính năng Bảng xếp hạng. Hãy tiếp tục học tập, tích lũy XP từ các bài học và bài quiz để sẵn sàng đua top cùng bạn bè nhé!
          </p>

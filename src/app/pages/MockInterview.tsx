...
const TOPICS = [
  { id:"t1", label:"React hooks & vòng đời"   },
  { id:"t2", label:"Khái niệm system design"  },
  { id:"t3", label:"Nền tảng TypeScript"      },
  { id:"t4", label:"Giải thuật & CTDL"        },
];
const QUESTIONS = [
  "Hãy giới thiệu bản thân và lý do bạn quan tâm đến frontend development.",
  "Bạn có thể giải thích sự khác nhau giữa controlled và uncontrolled components trong React không?",
  "Bạn tiếp cận tối ưu hiệu năng trong một ứng dụng React như thế nào?",
  "Hãy mô tả cách bạn thiết kế một giải pháp quản lý state có thể mở rộng.",
];
    ...
    >
      ...
      >
        ...
        <span style={{ fontSize:"0.78rem", color:OG, fontWeight:700, letterSpacing:"0.02em" }}>
          Studio phỏng vấn AI · Frontend Engineer
        </span>
      </motion.div>
      ...
      >
        <h1 style={{
          ...
          <span style={{ color:NAVY }}>Phỏng vấn thử: </span>
          <br/>
          <span style={{ color:OG }}>Lập trình viên Frontend</span>
        </h1>
      </motion.div>
      ...
      >
        Luyện tập cùng nhà tuyển dụng AI. Nhận chấm điểm theo thời gian thực về độ rõ ràng, chiều sâu kỹ thuật và sự tự tin.
      </motion.p>
      ...
      >
        ...
        <p style={{ fontSize:"0.75rem", color:T3, marginTop:"10px" }}>
          Bấm mic để trả lời. AI phản hồi theo thời gian thực.
        </p>
      </motion.div>
        ...
        {[
          {
            ...
            title:"Nói tự nhiên",
            sub:"Trả lời như một buổi phỏng vấn thật",
          },
          {
            icon: <Star size={18} color="#8B5CF6"/>,
            title:"Phản hồi AI",
            sub:"Chấm điểm ngay sau mỗi câu trả lời",
          },
          {
            icon: <BookOpen size={18} color="#0EA5E9"/>,
            title:"Xem lại sau",
            sub:"Lưu toàn bộ bản ghi buổi phỏng vấn",
          },
        ].map(c => (

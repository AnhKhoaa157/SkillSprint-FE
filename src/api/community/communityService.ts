...
export const communityService = {
  /**
   * Fetch approved posts with optional hashtag/search filtering
   */
   ...
   * Update a comment
   */
  updateComment: async (_postId: string, commentId: string, data: CreateCommentRequest): Promise<PostComment> => {

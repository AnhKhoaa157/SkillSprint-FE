...
export async function getAdminCommunityPosts(
  ...
  return requireData(
    await requestJson<AdminCommunityPageResponse<CommunityPostResponse>>(
      `${BASE_URL}/moderation/posts?${query.toString()}`,
    ),
  );
}
...
export async function getAdminCommunityComments(
  ...
  return requireData(
    await requestJson<AdminCommunityPageResponse<PostCommentResponse>>(
      `${BASE_URL}/moderation/comments?${query.toString()}`,
    ),
  );
}
...
export async function getAdminCommunityReports(
  ...
  return requireData(
    await requestJson<AdminCommunityPageResponse<ContentReportResponse>>(
      `${BASE_URL}/reports?${query.toString()}`,
    ),
  );
}
...
export async function getAdminCommunityRooms(
  ...
  return requireData(
    await requestJson<AdminCommunityPageResponse<CommunityRoomResponse>>(
      `${BASE_URL}/rooms?${query.toString()}`,
    ),
  );
}
